...
export function MagicButton({
  ...
  return (
    <button
      ...
      {...props}
    >
      <span className="absolute inset-[-1000%] animate-[spin_3s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,var(--color-1)_0%,var(--color-2)_50%,var(--color-3)_100%)]" 
            style={{
